...
In this tutorial, we aim to demonstrate the utility of the DietDiveR by applying it to the dietary data available from the National Health and Nutrition Examination Survey (NHANES).
